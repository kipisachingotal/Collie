...
function GrantPrivsModal({openGrantPrivs,handleCloseGrantPrivs,setOpenGrantPrivs,allNodes}) {
    ...
    const handleGrantPrivsToRole=() =>{
      console.log("trying to grant privs to : ", role)
      if (role==null){
        ...
        .then((response) => {
          console.log("Grant privs response :", response);
          Swal.fire({
        ...
        .catch((error) => {
          ...
          // alert(error)
          dispatch(setIsLoadingTree(false));
          alert("Couldn't grant Privileges")
        })
    ...
    return (
        ...
        >
            <StyledBootstrapDialogTitle id="customized-dialog-title" onClose={handleCloseGrantPrivs}>
            Grant Privileges
            </StyledBootstrapDialogTitle>
            <DialogContent dividers>
              <p>Select a Role to Grant Privileges</p>
              <Select
                  isMulti
            ...
            <DialogActions>
                <ModalStyledButton autoFocus onClick={handleCloseGrantPrivs} type="cancel">
                Cancel
                </ModalStyledButton>
                <ModalStyledButton autoFocus onClick = {handleGrantPrivsToRole} type="confirm">
                Grant
                </ModalStyledButton>
            </DialogActions>
        </BootstrapDialog>
...
export default GrantPrivsModal